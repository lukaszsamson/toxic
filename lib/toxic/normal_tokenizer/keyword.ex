defmodule Toxic.NormalTokenizer.Keyword do
  @moduledoc false
  import Toxic.Token
  import Toxic.Util, only: [strip_horizontal_space: 2, emit: 5, emit_with_eol: 5, multiple: 5]
  ...
  def tokenize_keyword(kind, rest, line, column, atom, length, scope, lookbehind) do
